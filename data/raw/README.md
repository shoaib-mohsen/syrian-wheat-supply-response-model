...
This directory contains the **raw dataset** used in the research project
on the responsiveness of Syrian wheat farmers to government procurement
prices (2002 to 2022).

The data have undergone only **minimal transformations** required to
standardize units, scales, and measurement formats. **No observations
were edited, replaced, or manipulated.**
...
* Agriculture Stress Index (ASI) Source: FAO Agricultural Stress Index
System (ASIS).
